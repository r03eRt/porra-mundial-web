...
| Cruces | ✅ | Cuadro de cruces estilo legacy, selector de participante, puntos por ronda/campeón y editor propio si la porra está abierta | `porra_knockout_picks` + `porra_matches` (stage `knockout`) |
