...
--
-- NOTA de orden: primero TABLAS, luego FUNCIONES (las funciones SQL validan su
-- cuerpo al crearse y necesitan que las tablas ya existan), luego políticas.
-- ============================================================================
...
-- ============================================================================
-- Helpers de autorización (después de las tablas que referencian)
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- Tablas de contenido: lectura pública, escritura solo del dueño de la porra.
-- ============================================================================
...
-- platform_admins: sin acceso directo (se consulta vía pp_is_admin), salvo
-- lectura de la propia fila para que el cliente sepa si es admin.
...
-- porras (tabla raíz): lectura pública; crear solo admins; editar/borrar dueño.
