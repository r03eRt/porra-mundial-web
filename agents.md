...
- ✅ Menú espejo de la app legacy (array `TABS` en `main.js`). Pestañas reales: Clasificación porra, Editar mi porra, Mini-porra, Partidos, Cruces, Clasificación grupos, Equipos, Detalle jugador, Histórico, **Mejores terceros**, **Probabilidades** y **Estadísticas**. El resto (Máximos goleadores, Comparador) salen como placeholder "próximamente" (`ready: false`)
