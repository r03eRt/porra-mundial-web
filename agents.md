...
- ✅ Menú espejo de la app legacy (array `TABS` en `main.js`). Pestañas reales: Clasificación porra, Editar mi porra, Mini-porra, Partidos, Cruces, Clasificación grupos, Equipos, Detalle jugador, Histórico, **Mejores terceros** y **Probabilidades**. El resto (Máximos goleadores, Estadísticas, Comparador) salen como placeholder "próximamente" (`ready: false`)
