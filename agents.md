...
- ✅ Menú espejo de la app legacy (array `TABS` en `main.js`). Pestañas reales: Clasificación porra, Editar mi porra, Mini-porra, Partidos, Cruces, Clasificación grupos, Equipos, Detalle jugador, Histórico, **Mejores terceros**, **Máximos goleadores**, **Probabilidades** y **Estadísticas**. La única restante (Comparador) sale como placeholder "próximamente" (`ready: false`)
